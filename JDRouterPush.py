...
# 环境变量
WSKEY = os.environ.get("WSKEY", "AAJgUBFTAEDr34RqpiU2AaFgt3YJltMDB46zUe4DYzIkmraRyLIQX3L6trKGzitxaPNmCVAWpfn37BSnQV0pzf_mZypc2qsr")  # 京东云无线宝中获取
SERVERPUSHKEY = os.environ.get("SERVERPUSHKEY", "SCU22127T6eda31180ce8a19d3c5b544e353722de603e4fdfeefd2")  # Server酱推送
...
DEVICENAME = os.environ.get("DEVICENAME", "139A9E:韭菜一号")  # 设备名称 mac后6位:设置的名称，多个使用&连接
